...
namespace GD.Engine
{
    public class OctahedronMesh : TexturedMesh<VertexPositionNormalTexture>
    {
        ...
        protected override void CreateGeometry()
        {
            ...
            Vector3 topLeftFront = new Vector3(1, 0, 0);
            Vector3 bottomLeftFront = new Vector3(0, -1, 0);
            Vector3 topRightFront = new Vector3(0, 0, 1);
            Vector3 bottomRightFront = new Vector3(1, 0, 0);
            Vector3 topLeftBack = new Vector3(0, 1, 0);
            Vector3 topRightBack = new Vector3(0, 0, -1);
            Vector3 bottomLeftBack = new Vector3(-1, 0, 0);
            Vector3 bottomRightBack = new Vector3(0, 1, 0);
            Vector3 topLeftFront1 = new Vector3(0, 0, 1);
            Vector3 bottomLeftFront1 = new Vector3(-1, 0, 0);
            Vector3 topRightFront1 = new Vector3(0, -1, 0);
            Vector3 bottomRightFront1 = new Vector3(0, 0, -1);
            Vector3 topLeftBack1 = new Vector3(0, 1, 0);
            Vector3 topRightBack1 = new Vector3(1, 0, 0);
            Vector3 bottomLeftBack1 = new Vector3(0, 0, 1);
            Vector3 bottomRightBack1 = new Vector3(0, 1, 0);
            Vector3 topLeftFront2 = new Vector3(-1, 0, 0);
            Vector3 bottomLeftFront2 = new Vector3(0, 0, -1);
            Vector3 topRightFront2 = new Vector3(0, -1, 0);
            Vector3 bottomRightFront2 = new Vector3(-1, 0, 0);
            Vector3 topLeftBack2 = new Vector3(0, 0, 1);
            Vector3 topRightBack2 = new Vector3(0, -1, 0);
            Vector3 bottomLeftBack2 = new Vector3(1, 0, 0);
            Vector3 bottomRightBack2 = new Vector3(0, 0, -1);
