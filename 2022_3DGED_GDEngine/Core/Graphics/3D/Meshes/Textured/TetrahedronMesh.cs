...
namespace GD.Engine
{
    ...
    {
        public TetrahedronMesh(GraphicsDevice graphicsDevice)
            : base(graphicsDevice)
        {
            Initialize();
        }
        ...
        protected override void CreateGeometry()
        {
            ...
            Vector3 topLeftFront = new Vector3(0.000f, 1.000f, 0.000f);
            Vector3 bottomLeftFront = new Vector3(-0.816f, -0.333f, -0.471f);
            Vector3 topRightFront = new Vector3(0.000f, -0.333f, 0.943f);
            Vector3 bottomRightFront = new Vector3(0.000f, 1.000f, 0.000f);
            Vector3 topLeftBack = new Vector3(0.816f, -0.333f, -0.471f);
            Vector3 topRightBack = new Vector3(-0.816f, -0.333f, -0.471f);
            Vector3 bottomLeftBack = new Vector3(0.000f, -0.333f, 0.943f);
            Vector3 bottomRightBack = new Vector3(0.816f, -0.333f, -0.471f);

            Vector3 topLeftFront1 = new Vector3(0.000f, 1.000f, 0.000f);
            Vector3 bottomLeftFront1 = new Vector3(-0.816f, -0.333f, -0.471f);
            Vector3 topRightFront1 = new Vector3(0.816f, -0.333f, -0.471f);
            Vector3 bottomRightFront1 = new Vector3(0.000f, -0.333f, 0.943f);
